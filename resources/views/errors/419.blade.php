    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        body {
            ...
            background: #0b0d14;
            background-image:
                radial-gradient(ellipse 70% 50% at 50% 0%, rgba(59, 130, 246, 0.06) 0%, transparent 60%),
                radial-gradient(ellipse 50% 40% at 70% 100%, rgba(217, 119, 6, 0.04) 0%, transparent 50%);
            position: relative;
            overflow: hidden;
        }
        body::before {
